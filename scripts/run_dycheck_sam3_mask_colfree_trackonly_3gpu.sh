...
OUTPUT_ROOT="$MOSCA_ROOT/output/sam3_mask_colfree_trackonly"
RUN_ROOT="$MOSCA_ROOT/logs/mosca_runs"
RUN_ID=$(date +%Y%m%d_%H%M%S)_dycheck_sam3_mask_colfree_trackonly_3gpu
RUN_DIR="$RUN_ROOT/$RUN_ID"
FIT_CFG=./profile/iphone/iphone_fit_colfree_sam3_trackonly.yaml
...
printf '%s\n' "$RUN_DIR" > "$RUN_ROOT/latest_dycheck_sam3_mask_colfree_trackonly_run.txt"
